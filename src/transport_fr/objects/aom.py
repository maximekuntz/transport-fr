class AOMResponse:
    ...
    def __repr__(self) -> str:
        s = "AOMResponse("
        s += f"departement={self.departement}, "
        s += f"forme_juridique={self.forme_juridique}, "
        s += f"insee_commune_principale={self.insee_commune_principale}, "
        s += f"nom={self.nom}, "
        s += f"siren={self.siren})"
        return s
...
class AOMShortRef:
    ...
    def __repr__(self) -> str:
        return f"AOMShortRef(name={self.name}, siren={self.siren})"
